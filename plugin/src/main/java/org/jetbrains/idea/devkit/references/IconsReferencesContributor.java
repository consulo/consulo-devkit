 ...
 *
 * TODO [VISTALL] rewrite using icon groups!
 */
...
//		});
	...
	{
		final String path = ModuleRootManager.getInstance(module).getContentFolderFiles(ContentFolderScopes.productionAndTest())[0].getPath();
