...
public class ConsuloSandboxRunState extends CommandLineState {
  ...
  public ConsuloSandboxRunState(@Nonnull ExecutionEnvironment environment,
                                @Nonnull Sdk javaSdk,
  ...
  private OwnJavaParameters createJavaParameters(@Nonnull ExecutionEnvironment env,
                                                 @Nonnull Sdk javaSdk,
                                                 @Nonnull String consuloSdkHome,
                                                 @Nullable String pluginsHomePath) throws ExecutionException {
  ...
  protected ConsuloPlatform addBootLibraries(@Nonnull String consuloHomePath,
                                             List<File> classpath,
