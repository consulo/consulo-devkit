...
public final class Consulo3PluginIds {
    ...
    private static final Set<PluginId> ourMergedObsoletePlugins =
        new HashSet<>(Arrays.asList(PluginId.getId("org.intellij.intelliLang")));

    private static final Set<PluginId> ourPlatformIds =
        new HashSet<>(Arrays.asList(CONSULO_DESKTOP_AWT, CONSULO_DESKTOP_SWT, CONSULO_WEB, CONSULO_REPO_ANALYZER));
