...
public class BnfFirstNextAnalyzer {
    ...
    private Map<BnfExpression, BnfExpression> calcNextInner(
        @Nonnull BnfExpression targetExpression,
    ...
    private Set<BnfExpression> calcSequenceFirstInner(
        ...
        for (int i = 0, size = list.size(); i < size; i++) {
            if (!result.remove(BNF_MATCHES_EOF)) {
                break;
            }
    ...
    public Set<BnfExpression> calcFirstInner(
    ...
    @Nonnull
    public static String asString(@Nonnull BnfExpression expression) {
        if (expression instanceof BnfLiteralExpression) {
    ...
    @Nonnull
    private static Set<BnfExpression> exprSetIntersection(@Nonnull Set<BnfExpression> a, @Nonnull Set<BnfExpression> b) {
    ...
    @Nonnull
    private static Set<BnfExpression> exprSetDifference(@Nonnull Set<BnfExpression> a, @Nonnull Set<BnfExpression> b) {
        Set<BnfExpression> filter = newExprSet(a);
