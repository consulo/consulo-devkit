...
public class GenOptions {
    ...
    public GenOptions(BnfFile bnfFile) {
        ...
        generateFirstCheck =
            getGenerateOption(version, bnfFile, KnownAttribute.GENERATE_FIRST_CHECK, genOptions, "first-check", "firstCheck");
        generateExtendedPin =
            getGenerateOption(version, bnfFile, KnownAttribute.EXTENDED_PIN, genOptions, "extended-pin", "extendedPin");
        generateTokenAccessors =
            getGenerateOption(version, bnfFile, KnownAttribute.GENERATE_TOKEN_ACCESSORS, genOptions, "token-accessors", "tokenAccessors");
