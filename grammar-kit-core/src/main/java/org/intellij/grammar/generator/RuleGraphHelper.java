...
public class RuleGraphHelper {
  ...
  public static Map<String, String> getTokenNameToTextMap(final BnfFile file) {
    return LanguageCachedValueUtil.getCachedValue(file,
                                                  () -> new CachedValueProvider.Result<>(computeTokens(file).asMap(file.getVersion()),
                                                                                         file));
  }
  ...
  public static Map<String, String> getTokenTextToNameMap(final BnfFile file) {
    return LanguageCachedValueUtil.getCachedValue(file,
                                                  () -> new CachedValueProvider.Result<>(computeTokens(file).asInverseMap(file.getVersion()),
                                                                                         file));
  }
  ...
  private Map<PsiElement, Cardinality> joinMaps(@Nonnull BnfRule rule,
                                                boolean tryCollapse,
                                                IElementType type,
